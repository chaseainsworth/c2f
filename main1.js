...
const usersInput = getInput(0);

function c2f(usersInput) {
  const result = (usersInput * 1.8) + 32;
  const endResult = usersInput + " degrees Celsius is " + result + " degrees in Fahrenheit.";
  return endResult;
}

console.log(c2f(usersInput));
